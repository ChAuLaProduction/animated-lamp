class Messages:
    ...
    MEDIA_MESSAGE_DELETED = "Dont Delete The File While Downlaoding, Send Again."
    CANNOT_OPEN_FILE = "Can't Open The File"
    PROCESS_TIMEOUT = (
        "Process failed due to timeout. Your process was "
    ...
    SCREENSHOT_PROCESS_FAILED = "Screenshot generation failed possibly due to some infrastructure failure"
    ...
    SAMPLE_VIDEO_PROCESS_FAILED = "Sample video generation failed possibly due to some infrastructure failure 😥."
    ...
    TRIM_VIDEO_RANGE_OUT_OF_VIDEO_DURATION = (
        "The requested range is out of the video's duration!."
    )
    TRIM_VIDEO_PROCESS_FAILED = (
        "Video trimming failed , Try Again"
    )
