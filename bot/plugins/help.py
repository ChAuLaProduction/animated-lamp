...
• I support any kind of **telegram video file** (streaming video or document video files).
• I also support **Streaming URLs**. The URL should be a --streaming URL--, --non IP specific--, and --should return proper response codes--.

Just Send The Telegram file or the streaming URL.
...
• If bot replies ' Can't Open The File ', the file might be --currupted-- or --malformatted--.

__If Issues Persists , Can't Do Anything Just Search For another Bot.__
